...
## **주어진 식**
\[
1.645 = \frac{C.V - 150}{12 / \sqrt{100}}
\]

여기서,

- **1.645**: 유의수준 5%에서의 **Z-값** (오른쪽 단측검정 기준)
- **150**: 모집단의 평균 (\(\mu\))
- **12**: 모집단의 표준편차 (\(\sigma\))
- **100**: 표본 크기 (\(n\))
...
## **Step 1: 표본표준편차(표준오차, Standard Error) 계산**
표본의 크기 \(n\)이 주어진 경우, 표준오차(standard error, SE)는 다음과 같이 구합니다.
...
\[
1.645 = \frac{C.V - 150}{1.2}
\]

양변에 1.2를 곱하면,

\[
1.645 \times 1.2 = C.V - 150
\]
...
## **Step 3: C.V. 계산**
\[
C.V = 150 + 1.974 = 151.974
\]

따라서, **임계값(C.V.) = 151.974** 입니다.
