...
새로운 서비스 개선 정책을 도입한 후, 무작위로 40명의 고객을 대상으로 응답 시간을 조사한 결과, 평균 응답 시간이 14분으로 측정되었습니다.  
이 서비스 개선 정책이 응답 시간을 유의미하게 단축시켰다고 주장할 수 있을까요?  
유의수준 0.05에서 검정을 수행하세요.
...
6. 결론: 서비스 개선 정책이 응답 시간을 단축시켰다고 주장할 수 있는지 결론을 내리세요.
