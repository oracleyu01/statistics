...
- **예제51. 가설검정1.단일 모집단의 모평균 검정: 분산을 아는 경우(Z 검정)**: 📄[노트]()
- **예제52. 가설검정2.단일 모집단의 모평균 검정: 분산을 모르는 경우 (t 검정)**: 📄[노트]()
- **예제53. 가설검정3.두 모집단의 모평균 차이 검정: 독립표본, 동분산 (t 검정)**: 📄[노트]()
- **예제54. 가설검정4.두 모집단의 모평균 차이 검정: 독립표본, 분산이 다른 경우 (t 검정)**: 📄[노트]()
- **예제55. 가설검정5.두 모집단의 모평균 차이 검정: 대응표본 (t 검정)**: 📄[노트]()
- **예제56. 가설검정6.세 모집단 이상의 모평균 차이 검정 (ANOVA)**: 📄[노트]()
- **예제57. 가설검정7.정규분포를 따르지 않는 경우 - 비모수적 가설 검정**:  📄[노트]()
