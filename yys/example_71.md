...
2024년 40회 기출문제
Q. 다음 중 군집분석 방법에 대한 설명으로 가장 옳지 않은 것은?

K-means는 사전에 군집 수를 정해야 한다
DBSCAN은 밀도 기반 군집화로 임의 형태의 군집을 찾을 수 있다
Single Linkage Method는 계층적 군집화 방법이다
주성분 분석(PCA)은 군집 간 거리를 기반으로 군집화를 수행한다

<details>
<summary>정답 및 해설 보기</summary>
<div markdown="1">
정답: 4
해설: PCA는 차원 축소 기법이며, 군집화 방법이 아닙니다.
</div>
</details>
2023년 38회 기출문제
Q. K-means 알고리즘에 대한 설명으로 옳은 것은?
...
<div markdown="1">
정답: 3
해설: K-means는 이상치와 잡음에 민감하며, 이는 알고리즘의 주요 한계점 중 하나입니다.
</div>
</details>
2023년 37회 기출문제
Q. K-means 군집화의 특징으로 가장 적절하지 않은 것은?

비계층적 군집화 방법이다
군집 수 K를 사전에 지정해야 한다
군집 내 분산을 최소화하는 방향으로 동작한다
모든 데이터 유형에 적용 가능하다
...
<div markdown="1">
정답: 4
해설: K-means는 범주형 변수에 직접 적용하기 어려우며, 주로 연속형 변수에 적용됩니다.
</div>
</details> CopyRet
