...
✅ 정답: 4) 주성분 분석(PCA)은 군집 간 거리를 기반으로 군집화를 수행한다

🔍 해설:
PCA는 차원 축소 기법이며, 군집화 방법이 아닙니다.
...
✅ 정답: 3) 잡음이나 이상값에 영향을 받기 쉽다

🔍 해설:
K-means는 이상치와 잡음에 민감하며, 이는 알고리즘의 주요 한계점 중 하나입니다.
...
✅ 정답: 4) 모든 데이터 유형에 적용 가능하다

🔍 해설:
K-means는 범주형 변수에 직접 적용하기 어려우며, 주로 연속형 변수에 적용됩니다.
